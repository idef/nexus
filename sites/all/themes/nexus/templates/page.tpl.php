      ...
      <li>
        ...
        <?php if($slide1_head || $slide1_desc) : ?>
          <div class="flex-caption">
            ...
            <a class="frmore" href="<?php print url($slide1_url); ?>"> <?php print t('ACCEDER'); ?> </a>
          </div>
        <?php endif; ?>
      </li>
      <li>
        ...
        <?php if($slide2_head || $slide2_desc) : ?>
          <div class="flex-caption">
            ...
            <a class="frmore" href="<?php print url($slide2_url); ?>"> <?php print t('ACCEDER'); ?> </a>
          </div>
        <?php endif; ?>
      </li>
      <li>
        ...
        <?php if($slide3_head || $slide3_desc) : ?>
          <div class="flex-caption">
            ...
            <a class="frmore" href="<?php print url($slide3_url); ?>"> <?php print t('ACCEDER'); ?> </a>
          </div>
        <?php endif; ?>
      </li>
    </ul><!-- /slides -->
